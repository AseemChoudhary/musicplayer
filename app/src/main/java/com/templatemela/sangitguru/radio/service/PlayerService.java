...
import com.templatemela.sangitguru.radio.FavouriteManager;
import com.templatemela.sangitguru.radio.HistoryManager;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.templatemela.sangitguru.radio.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.templatemela.sangitguru.radio.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "com.templatemela.sangitguru.radio.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "com.templatemela.sangitguru.radio.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "com.templatemela.sangitguru.radio.playerservicebound";
