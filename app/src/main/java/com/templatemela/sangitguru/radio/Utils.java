...
import com.templatemela.sangitguru.radio.service.ConnectivityChecker;
...
import com.templatemela.sangitguru.radio.utils.Tls12SocketFactory;
...
public class Utils {
    ...
    public static String getCacheFile(Context ctx, String theURI) {
        ...
        try {
            ...
            Log.e("UTIL", "getCacheFile() " + exception);
        }
        return null;
    }
    ...
    private static String downloadFeed(OkHttpClient httpClient, Context ctx, String theURI, boolean forceUpdate, Map<String, String> dictParams) {
        ...
        try {
            ...
            Log.e("UTIL", "downloadFeed() " + exception);
        }
    ...
    public static String downloadFeedRelative(OkHttpClient httpClient, Context ctx, String theRelativeUri, boolean forceUpdate, Map<String, String> dictParams) {
        ...
        String currentServer = com.templatemela.sangitguru.radio.RadioBrowserServerManager.getCurrentServer();
        if (currentServer == null) {
            return null;
        }

        String endpoint = com.templatemela.sangitguru.radio.RadioBrowserServerManager.constructEndpoint(currentServer, theRelativeUri);
        ...
        String[] serverList = com.templatemela.sangitguru.radio.RadioBrowserServerManager.getServerList(false);
        ...
        for (String newServer : serverList) {
            ...
            endpoint = com.templatemela.sangitguru.radio.RadioBrowserServerManager.constructEndpoint(newServer, theRelativeUri);
            result = downloadFeed(httpClient, ctx, endpoint, forceUpdate, dictParams);
            if (result != null) {
                // set the working server as new current server
                com.templatemela.sangitguru.radio.RadioBrowserServerManager.setCurrentServer(newServer);
                return result;
            }
        }
    ...
    public static String getRealStationLink(OkHttpClient httpClient, Context ctx, String stationId) {
        ...
        if (result != null) {
            ...
            try {
                ...
                Log.e("UTIL", "getRealStationLink() " + exception);
            }
        }
        return null;
    }
    ...
    public static DataRadioStation getStationById(OkHttpClient httpClient, Context ctx, String stationId) {
        ...
        if (result != null) {
            try {
                ...
                Log.e("UTIL", "getStationByid() " + exception);
            }
        }
        return null;
    }
    ...
    public static DataRadioStation getStationByUuid(OkHttpClient httpClient, Context ctx, String stationUuid) {
        ...
        if (result != null) {
            try {
                ...
                Log.e("UTIL", "getStationByUuid() " + exception);
            }
        }
        return null;
    }
    ...
    public static List<DataRadioStation> getStationsByUuid(OkHttpClient httpClient, Context ctx, Iterable<String> listUUids) {
        ...
        if (result != null) {
            try {
                ...
                Log.e("UTIL", "getStationsByUuid() " + exception);
            }
        }
        return null;
    }
    ...
    public static void showPlaySelection(final MainRadioHelper radioDroidApp, final DataRadioStation station, final FragmentManager fragmentManager) {
    ...
    public static void playAndWarnIfMetered(MainRadioHelper radioDroidApp, DataRadioStation station, PlayerType playerType, Runnable playFunc) {
    ...
    public static void playAndWarnIfMetered(MainRadioHelper radioDroidApp, DataRadioStation station, PlayerType playerType,
    ...
    public static void play(final MainRadioHelper radioDroidApp, final DataRadioStation station) {
    ...
    public static OkHttpClient.Builder enableTls12OnPreLollipop(OkHttpClient.Builder client) {
        if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 22) {
            try {
                ...
                Log.e("OkHttpTLSCompat", "Error while setting TLS 1.2", exceptionxc);
            }
        }
