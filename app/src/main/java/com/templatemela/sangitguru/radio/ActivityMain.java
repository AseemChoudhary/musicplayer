...
import com.templatemela.sangitguru.radio.alarm.FragmentAlarm;
import com.templatemela.sangitguru.radio.alarm.TimePickerFragment;
import com.templatemela.sangitguru.radio.cast.CastAwareActivity;
import com.templatemela.sangitguru.radio.interfaces.IFragmentSearchable;
import com.templatemela.sangitguru.radio.players.PlayState;
import com.templatemela.sangitguru.radio.players.PlayStationTask;
import com.templatemela.sangitguru.radio.players.mpd.MPDClient;
import com.templatemela.sangitguru.radio.players.mpd.MPDServersRepository;
import com.templatemela.sangitguru.radio.players.selector.PlayerType;
import com.templatemela.sangitguru.radio.service.MediaSessionCallback;
import com.templatemela.sangitguru.radio.service.PlayerService;
import com.templatemela.sangitguru.radio.service.PlayerServiceUtil;
...
import static com.templatemela.sangitguru.radio.service.MediaSessionCallback.EXTRA_STATION_UUID;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_SHOW_LOADING = "com.templatemela.sangitguru.radio.show_loading";
    public static final String ACTION_HIDE_LOADING = "com.templatemela.sangitguru.radio.hide_loading";
    ...
    private com.templatemela.sangitguru.radio.FragmentPlayerSmall smallPlayerFragment;
    private com.templatemela.sangitguru.radio.FragmentPlayerFull fullPlayerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(com.templatemela.sangitguru.radio.Utils.getThemeResId(this));
        ...
        if (com.templatemela.sangitguru.radio.Utils.bottomNavigationEnabled(this)) {
        ...
        smallPlayerFragment = (com.templatemela.sangitguru.radio.FragmentPlayerSmall) mFragmentManager.findFragmentById(R.id.fragment_player_small);
        fullPlayerFragment = (com.templatemela.sangitguru.radio.FragmentPlayerFull) mFragmentManager.findFragmentById(R.id.fragment_player_full);

        if (smallPlayerFragment == null || fullPlayerFragment == null) {
            smallPlayerFragment = new com.templatemela.sangitguru.radio.FragmentPlayerSmall();
            fullPlayerFragment = new com.templatemela.sangitguru.radio.FragmentPlayerFull();
        ...
        smallPlayerFragment.setCallback(new com.templatemela.sangitguru.radio.FragmentPlayerSmall.Callback() {
            @Override
            public void onToggle() {
                toggleBottomSheetState();
            }
        });
        fullPlayerFragment.setTouchInterceptListener(new com.templatemela.sangitguru.radio.FragmentPlayerFull.TouchInterceptListener() {
            @Override
        ...
        playerBottomSheet.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                ...
                if (newState == BottomSheetBehavior.STATE_EXPANDED) {
                    ...
                    smallPlayerFragment.setRole(com.templatemela.sangitguru.radio.FragmentPlayerSmall.Role.HEADER);
                    FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
                    fragmentTransaction.hide(mFragmentManager.findFragmentById(R.id.containerView));
                    fragmentTransaction.commit();
                } else if (newState == BottomSheetBehavior.STATE_COLLAPSED) {
                    appBarLayout.setExpanded(true);
                    smallPlayerFragment.setRole(com.templatemela.sangitguru.radio.FragmentPlayerSmall.Role.PLAYER);
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (selectedMenuItem) {
            case R.id.nav_item_stations:
                f = new com.templatemela.sangitguru.radio.FragmentTabs();
                break;
            case R.id.nav_item_starred:
                f = new com.templatemela.sangitguru.radio.FragmentStarred();
                break;
            case R.id.nav_item_history:
                f = new com.templatemela.sangitguru.radio.FragmentHistory();
                break;
        ...
        if (MediaSessionCallback.ACTION_PLAY_STATION_BY_UUID.equals(action)) {
            ...
            new AsyncTask<Void, Void, DataRadioStation>() {
                ...
                protected DataRadioStation doInBackground(Void... params) {
                    return com.templatemela.sangitguru.radio.Utils.getStationByUuid(httpClient, context, stationUUID);
                }
                ...
                protected void onPostExecute(DataRadioStation station) {
                    if (!isFinishing()) {
                        if (station != null) {
                            com.templatemela.sangitguru.radio.Utils.showPlaySelection(radioDroidApp, station, getSupportFragmentManager());

                            Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
                            if (currentFragment instanceof com.templatemela.sangitguru.radio.FragmentHistory) {
                                ((com.templatemela.sangitguru.radio.FragmentHistory) currentFragment).RefreshListGui();
                            }
                        }
                    }
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (com.templatemela.sangitguru.radio.Utils.bottomNavigationEnabled(ActivityMain.this)) {
 ...
 */
    ...
    public void onFileSelected(FileDialog dialog, File file) {
        try {
            ...
            MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
            com.templatemela.sangitguru.radio.FavouriteManager favouriteManager = radioDroidApp.getFavouriteManager();
            com.templatemela.sangitguru.radio.HistoryManager historyManager = radioDroidApp.getHistoryManager();
    ...
    void SaveFavourites() {
        ...
        dialog.setStyle(DialogFragment.STYLE_NO_TITLE, com.templatemela.sangitguru.radio.Utils.getThemeResId(this));
    ...
    void LoadFavourites() {
        ...
        dialogOpen.setStyle(DialogFragment.STYLE_NO_TITLE, com.templatemela.sangitguru.radio.Utils.getThemeResId(this));
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_save:
                try {
                    if (com.templatemela.sangitguru.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_SAVE)) {
                        SaveFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
            ...
            case R.id.action_load:
                try {
                    if (com.templatemela.sangitguru.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_LOAD)) {
                        LoadFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
    ...
    private void setupStartUpFragment() {
        ...
        MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
        com.templatemela.sangitguru.radio.HistoryManager hm = radioDroidApp.getHistoryManager();
        com.templatemela.sangitguru.radio.FavouriteManager fm = radioDroidApp.getFavouriteManager();
    ...
    public void Search(StationsFilter.SearchStyle searchStyle, String query) {
        ...
        Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
        if (currentFragment instanceof com.templatemela.sangitguru.radio.FragmentTabs) {
            ((com.templatemela.sangitguru.radio.FragmentTabs) currentFragment).Search(searchStyle, query);
        } else {
            String backStackTag = String.valueOf(R.id.nav_item_stations);
            com.templatemela.sangitguru.radio.FragmentTabs f = new com.templatemela.sangitguru.radio.FragmentTabs();
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            if (com.templatemela.sangitguru.radio.Utils.bottomNavigationEnabled(this)) {
                fragmentTransaction.replace(R.id.containerView, f).commit();
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(ACTION_HIDE_LOADING)) {
                    ...
                    switch (playerType) {
                        case RADIODROID:
                            showMeteredConnectionDialog(() -> com.templatemela.sangitguru.radio.Utils.play((MainRadioHelper) getApplication(), PlayerServiceUtil.getCurrentStation()));
                            break;
                        case EXTERNAL:
