...
import static com.music.musicplayer.mp3player.MainActivity.bassStrength;
import static com.music.musicplayer.mp3player.MainActivity.favouriteTracks;
import static com.music.musicplayer.mp3player.MainActivity.isEqualizerEnabled;
import static com.music.musicplayer.mp3player.MainActivity.isEqualizerReloaded;
import static com.music.musicplayer.mp3player.MainActivity.presetPos;
import static com.music.musicplayer.mp3player.MainActivity.repeatEnabled;
import static com.music.musicplayer.mp3player.MainActivity.repeatOnceEnabled;
import static com.music.musicplayer.mp3player.MainActivity.reverbPreset;
import static com.music.musicplayer.mp3player.MainActivity.seekbarPos;
...
import com.music.musicplayer.mp3player.musicplayer.fragment.EffectsFragment;
import com.music.musicplayer.mp3player.musicplayer.fragment.EnvironmentFragment;
import com.music.musicplayer.mp3player.musicplayer.fragment.EqualizerFragment;
import com.music.musicplayer.mp3player.musicplayer.fragment.VisualizerFragment;
    ...
    private void clicks() {
        ...
        favouriteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new MainActivity.SaveFavourites().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            }
        });
