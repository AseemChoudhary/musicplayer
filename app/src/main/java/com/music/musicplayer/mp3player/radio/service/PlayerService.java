package com.music.musicplayer.mp3player.radio.service;
...
import com.music.musicplayer.mp3player.radio.ActivityMain;

import com.music.musicplayer.mp3player.radio.FavouriteManager;
import com.music.musicplayer.mp3player.radio.HistoryManager;
import com.music.musicplayer.mp3player.R;
import com.music.musicplayer.mp3player.radio.IPlayerService;
import com.music.musicplayer.mp3player.radio.MainRadioHelper;
import com.music.musicplayer.mp3player.radio.Utils;
...
import com.music.musicplayer.mp3player.radio.players.RadioPlayer;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.music.musicplayer.mp3player.radio.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.music.musicplayer.mp3player.radio.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "com.music.musicplayer.mp3player.radio.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "com.music.musicplayer.mp3player.radio.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "com.music.musicplayer.mp3player.radio.playerservicebound";
    ...
    public void onCreate() {
        ...
        radioIcon = ((BitmapDrawable) ResourcesCompat.getDrawable(getResources(), R.drawable.app_icon, null));
    ...
    private void setMediaPlaybackState(int state) {
        ...
        if (state == PlaybackStateCompat.STATE_ERROR) {
            ...
            if ((currentPlayerState == PlayState.Paused || currentPlayerState == PlayState.Idle)
                ...
                } catch (Resources.NotFoundException exceptionx) {
                    Log.e(TAG, String.format("Unknown play error: %d", lastErrorFromPlayer), exceptionx);
                }
            }
