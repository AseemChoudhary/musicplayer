...
import com.music.musicplayer.mp3player.radio.adapters.AlbumTabLayoutAdapter;
import com.music.musicplayer.mp3player.radio.history.TrackHistoryAdapter;
import com.music.musicplayer.mp3player.radio.history.TrackHistoryEntry;
import com.music.musicplayer.mp3player.radio.history.TrackHistoryRepository;
import com.music.musicplayer.mp3player.radio.history.TrackHistoryViewModel;
import com.music.musicplayer.mp3player.radio.recording.Recordable;
import com.music.musicplayer.mp3player.radio.recording.RecordingsAdapter;
import com.music.musicplayer.mp3player.radio.recording.RecordingsManager;
import com.music.musicplayer.mp3player.radio.recording.RunningRecordingInfo;
...
import com.music.musicplayer.mp3player.radio.station.live.metadata.TrackMetadata;
import com.music.musicplayer.mp3player.radio.station.live.metadata.TrackMetadataCallback;
import com.music.musicplayer.mp3player.radio.station.live.metadata.TrackMetadataSearcher;
import com.music.musicplayer.mp3player.radio.utils.RefreshHandler;
import com.music.musicplayer.mp3player.radio.views.RecyclerAwareNestedScrollView;
import com.music.musicplayer.mp3player.radio.views.TagsView;
...
*/
    ...
    private void fullUpdate() {
        ...
        if (station != null) {
            ...
            Drawable flag = com.music.musicplayer.mp3player.radio.CountryFlagsLoader.getInstance().getFlag(requireContext(), station.CountryCode);
            if (flag != null) {
