...
import com.music.musicplayer.mp3player.radio.alarm.FragmentAlarm;
import com.music.musicplayer.mp3player.radio.alarm.TimePickerFragment;
import com.music.musicplayer.mp3player.radio.cast.CastAwareActivity;
import com.music.musicplayer.mp3player.radio.interfaces.IFragmentSearchable;
import com.music.musicplayer.mp3player.radio.players.PlayState;
import com.music.musicplayer.mp3player.radio.players.PlayStationTask;
import com.music.musicplayer.mp3player.radio.players.mpd.MPDClient;
import com.music.musicplayer.mp3player.radio.players.mpd.MPDServersRepository;
import com.music.musicplayer.mp3player.radio.players.selector.PlayerType;
import com.music.musicplayer.mp3player.radio.service.MediaSessionCallback;
import com.music.musicplayer.mp3player.radio.service.PlayerService;
...
import static com.music.musicplayer.mp3player.radio.service.MediaSessionCallback.EXTRA_STATION_UUID;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_SHOW_LOADING = "com.music.musicplayer.mp3player.radio.show_loading";
    public static final String ACTION_HIDE_LOADING = "com.music.musicplayer.mp3player.radio.hide_loading";
    ...
    private com.music.musicplayer.mp3player.radio.FragmentPlayerSmall smallPlayerFragment;
    private com.music.musicplayer.mp3player.radio.FragmentPlayerFull fullPlayerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(com.music.musicplayer.mp3player.radio.Utils.getThemeResId(this));
        ...
        if (com.music.musicplayer.mp3player.radio.Utils.bottomNavigationEnabled(this)) {
        ...
        smallPlayerFragment = (com.music.musicplayer.mp3player.radio.FragmentPlayerSmall) mFragmentManager.findFragmentById(R.id.fragment_player_small);
        fullPlayerFragment = (com.music.musicplayer.mp3player.radio.FragmentPlayerFull) mFragmentManager.findFragmentById(R.id.fragment_player_full);

        if (smallPlayerFragment == null || fullPlayerFragment == null) {
            smallPlayerFragment = new com.music.musicplayer.mp3player.radio.FragmentPlayerSmall();
            fullPlayerFragment = new com.music.musicplayer.mp3player.radio.FragmentPlayerFull();
        ...
        smallPlayerFragment.setCallback(new com.music.musicplayer.mp3player.radio.FragmentPlayerSmall.Callback() {
            @Override
            public void onToggle() {
                toggleBottomSheetState();
            }
        });
        fullPlayerFragment.setTouchInterceptListener(new com.music.musicplayer.mp3player.radio.FragmentPlayerFull.TouchInterceptListener() {
            @Override
        ...
        playerBottomSheet.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                ...
                if (newState == BottomSheetBehavior.STATE_EXPANDED) {
                    ...
                    smallPlayerFragment.setRole(com.music.musicplayer.mp3player.radio.FragmentPlayerSmall.Role.HEADER);
                    FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
                    fragmentTransaction.hide(mFragmentManager.findFragmentById(R.id.containerView));
                    fragmentTransaction.commit();
                } else if (newState == BottomSheetBehavior.STATE_COLLAPSED) {
                    appBarLayout.setExpanded(true);
                    smallPlayerFragment.setRole(com.music.musicplayer.mp3player.radio.FragmentPlayerSmall.Role.PLAYER);
        ...
        ((MainRadioHelper) getApplication()).getCastHandler().onCreate(this);
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (selectedMenuItem) {
            case R.id.nav_item_stations:
                f = new com.music.musicplayer.mp3player.radio.FragmentTabs();
                break;
            case R.id.nav_item_starred:
                f = new com.music.musicplayer.mp3player.radio.FragmentStarred();
                break;
            case R.id.nav_item_history:
                f = new com.music.musicplayer.mp3player.radio.FragmentHistory();
                break;
    ...
    protected void onPause() {
        ...
        CastHandler castHandler = ((MainRadioHelper) getApplication()).getCastHandler();
        castHandler.onPause();
    ...
    private void handleIntent(@NonNull Intent intent) {
        ...
        if (MediaSessionCallback.ACTION_PLAY_STATION_BY_UUID.equals(action)) {
            ...
            MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
            final OkHttpClient httpClient = radioDroidApp.getHttpClient();

            new AsyncTask<Void, Void, DataRadioStation>() {
                @Override
                protected DataRadioStation doInBackground(Void... params) {
                    return com.music.musicplayer.mp3player.radio.Utils.getStationByUuid(httpClient, context, stationUUID);
                }
                ...
                protected void onPostExecute(DataRadioStation station) {
                    if (!isFinishing()) {
                        if (station != null) {
                            com.music.musicplayer.mp3player.radio.Utils.showPlaySelection(radioDroidApp, station, getSupportFragmentManager());

                            Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
                            if (currentFragment instanceof com.music.musicplayer.mp3player.radio.FragmentHistory) {
                                ((com.music.musicplayer.mp3player.radio.FragmentHistory) currentFragment).RefreshListGui();
                            }
                        }
                    }
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (com.music.musicplayer.mp3player.radio.Utils.bottomNavigationEnabled(ActivityMain.this)) {
 ...
 */
        ...
        ((MainRadioHelper) getApplication()).getCastHandler().getRouteItem(getApplicationContext(), menu);
    ...
    public void onFileSelected(FileDialog dialog, File file) {
        try {
            ...
            MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
            com.music.musicplayer.mp3player.radio.FavouriteManager favouriteManager = radioDroidApp.getFavouriteManager();
            com.music.musicplayer.mp3player.radio.HistoryManager historyManager = radioDroidApp.getHistoryManager();
    ...
    void SaveFavourites() {
        ...
        dialog.setStyle(DialogFragment.STYLE_NO_TITLE, com.music.musicplayer.mp3player.radio.Utils.getThemeResId(this));
    ...
    void LoadFavourites() {
        ...
        dialogOpen.setStyle(DialogFragment.STYLE_NO_TITLE, com.music.musicplayer.mp3player.radio.Utils.getThemeResId(this));
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_save:
                try {
                    if (com.music.musicplayer.mp3player.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_SAVE)) {
                        SaveFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
            ...
            case R.id.action_load:
                try {
                    if (com.music.musicplayer.mp3player.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_LOAD)) {
                        LoadFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
    ...
    private void setupStartUpFragment() {
        ...
        MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
        com.music.musicplayer.mp3player.radio.HistoryManager hm = radioDroidApp.getHistoryManager();
        com.music.musicplayer.mp3player.radio.FavouriteManager fm = radioDroidApp.getFavouriteManager();
    ...
    public void Search(StationsFilter.SearchStyle searchStyle, String query) {
        ...
        Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
        if (currentFragment instanceof com.music.musicplayer.mp3player.radio.FragmentTabs) {
            ((com.music.musicplayer.mp3player.radio.FragmentTabs) currentFragment).Search(searchStyle, query);
        } else {
            String backStackTag = String.valueOf(R.id.nav_item_stations);
            com.music.musicplayer.mp3player.radio.FragmentTabs f = new com.music.musicplayer.mp3player.radio.FragmentTabs();
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            if (com.music.musicplayer.mp3player.radio.Utils.bottomNavigationEnabled(this)) {
                fragmentTransaction.replace(R.id.containerView, f).commit();
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(ACTION_HIDE_LOADING)) {
                    ...
                    switch (playerType) {
                        case RADIODROID:
                            showMeteredConnectionDialog(() -> com.music.musicplayer.mp3player.radio.Utils.play((MainRadioHelper) getApplication(), PlayerServiceUtil.getCurrentStation()));
                            break;
                        case EXTERNAL:
