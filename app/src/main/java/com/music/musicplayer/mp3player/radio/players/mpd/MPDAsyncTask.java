package com.music.musicplayer.mp3player.radio.players.mpd;
...
public class MPDAsyncTask implements Runnable {
    ...
    protected static ReadStage okReadStage() {
        return (task, result) -> {
    ...
    protected static WriteStage statusWriteStage() {
    ...
    protected static WriteStage loginWriteStage(String password) {
        return (task, bufferedWriter) -> {
    ...
    protected static ReadStage statusReadStage(boolean c) {
        return (task, result) -> {
