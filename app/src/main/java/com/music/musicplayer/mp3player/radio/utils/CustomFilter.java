package com.music.musicplayer.mp3player.radio.utils;
...
/**
 * This is a copy of {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     *
     * @see #filter(CharSequence, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * must be returned as a {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults)
     * @see com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults
     */
    protected abstract com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults results);
     ...
     * {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter#filter(CharSequence, com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterListener)},
    ...
    private class RequestHandler extends Handler {
         ...
         * {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter#performFiltering} and then sending a message
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults();
                        Log.w(LOG_TAG, "An exception occured during performFiltering()!", exception);
                    } finally {
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter#publishResults(CharSequence,
         * com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterResults)}
    ...
    private static class RequestArguments {
         ...
         */
        com.music.musicplayer.mp3player.radio.utils.CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link com.music.musicplayer.mp3player.radio.utils.CustomFilter#filter(CharSequence)}
