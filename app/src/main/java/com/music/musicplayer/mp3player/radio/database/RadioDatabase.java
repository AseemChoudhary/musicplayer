package com.music.musicplayer.mp3player.radio.database;
...
import com.music.musicplayer.mp3player.radio.history.TrackHistoryDao;
import com.music.musicplayer.mp3player.radio.history.TrackHistoryEntry;

import java.util.concurrent.Executor;
import java.util.concurrent.Executors;

import static com.music.musicplayer.mp3player.radio.history.TrackHistoryEntry.MAX_UNKNOWN_TRACK_DURATION;
