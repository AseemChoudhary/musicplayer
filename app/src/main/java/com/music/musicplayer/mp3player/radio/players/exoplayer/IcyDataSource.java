package com.music.musicplayer.mp3player.radio.players.exoplayer;
...
import static com.music.musicplayer.mp3player.radio.Utils.getMimeType;
...
public class IcyDataSource implements HttpDataSource {
    ...
    private long connect() throws HttpDataSourceException {
        ...
        try {
            ...
            throw new HttpDataSourceException("Unable to connect to " + dataSpec.uri.toString(), exception,
    ...
    private int readInternal(byte[] buffer, int offset, int readLength) throws HttpDataSourceException {
        ...
        try {
            ...
            throw new HttpDataSourceException(exception, dataSpec, HttpDataSourceException.TYPE_READ);
        }
