        ...
        try {
            ...
            while (!isStopped && retry > 0) {
                ...
                try {
                    ...
                    Log.e(TAG, "exception occurred inside the connection loop, retry.", exception);
                } finally {
            ...
            Log.e(TAG, "Interrupted ex Proxy() ", exception);
        } finally {
            try {
                if (proxyServer != null) {
                    proxyServer.close();
                ...
                Log.e(TAG, "exception occurred while closing resources.", exception);
            }
        }
