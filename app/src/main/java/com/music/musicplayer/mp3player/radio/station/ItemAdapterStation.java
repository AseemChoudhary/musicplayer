...
import com.music.musicplayer.mp3player.radio.utils.RecyclerItemMoveAndSwipeHelper;
...
import com.music.musicplayer.mp3player.radio.utils.RecyclerItemSwipeHelper;
import com.music.musicplayer.mp3player.radio.utils.SwipeableViewHolder;
...
public class ItemAdapterStation
    ...
    public void updateList(com.music.musicplayer.mp3player.radio.FragmentStarred refreshableList, List<DataRadioStation> stationsList) {
    ...
    public void onBindViewHolder(final StationViewHolder holder, int position) {
        ...
        Drawable flag = com.music.musicplayer.mp3player.radio.CountryFlagsLoader.getInstance().getFlag(activity, station.CountryCode);
