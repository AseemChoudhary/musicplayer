...
public class RadioMainBrowser {
    ...
    private MainRadioHelper radioDroidApp;
    ...
    private static class RetrieveStationsIconAndSendResult extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            for (final DataRadioStation station : stations) {
                ...
                Picasso.get().load((!station.hasIcon() ? resourceToUri(resources, R.drawable.app_icon).toString() : station.IconUrl))
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for (DataRadioStation station : stations) {
                ...
                if (stationIcon == null)
                    stationIcon = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.app_icon);
    ...
    public RadioMainBrowser(MainRadioHelper radioDroidApp) {
