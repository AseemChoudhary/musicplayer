...
import com.music.musicplayer.mp3player.radio.service.ConnectivityChecker;
...
import com.music.musicplayer.mp3player.radio.utils.Tls12SocketFactory;
...
public class Utils {
    ...
    public static String downloadFeedRelative(OkHttpClient httpClient, Context ctx, String theRelativeUri, boolean forceUpdate, Map<String, String> dictParams) {
        ...
        String currentServer = com.music.musicplayer.mp3player.radio.RadioBrowserServerManager.getCurrentServer();
        if (currentServer == null) {
            return null;
        }

        String endpoint = com.music.musicplayer.mp3player.radio.RadioBrowserServerManager.constructEndpoint(currentServer, theRelativeUri);
        ...
        String[] serverList = com.music.musicplayer.mp3player.radio.RadioBrowserServerManager.getServerList(false);
        ...
        for (String newServer : serverList) {
            ...
            endpoint = com.music.musicplayer.mp3player.radio.RadioBrowserServerManager.constructEndpoint(newServer, theRelativeUri);
            result = downloadFeed(httpClient, ctx, endpoint, forceUpdate, dictParams);
            if (result != null) {
                // set the working server as new current server
                com.music.musicplayer.mp3player.radio.RadioBrowserServerManager.setCurrentServer(newServer);
                return result;
            }
        }
