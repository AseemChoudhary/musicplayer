package com.music.musicplayer.mp3player.radio.views;
...
public class TagsView extends AppCompatTextView {
    ...
    private int mTagHeight = 25;
    private int mTextHorizontalPadding = 10;
    private int mTextVerticalMargin = 10;
    ...
    public void setTags(List<String> tags) {
        ...
        for (final String tag : tags) {
            ...
            mTextVerticalMargin=10;
            RoundedBackgroundSpan span = new RoundedBackgroundSpan(mTagHeight, mCornerRadius,
                    mTextHorizontalPadding, mTextVerticalMargin, getResources().getColor(R.color.tagColor), getCurrentTextColor());
