package com.music.musicplayer.mp3player.radio.players;
...
import com.music.musicplayer.mp3player.radio.players.exoplayer.ExoPlayerWrapper;
import com.music.musicplayer.mp3player.radio.players.mediaplayer.MediaPlayerWrapper;
import com.music.musicplayer.mp3player.radio.recording.Recordable;
import com.music.musicplayer.mp3player.radio.recording.RecordableListener;
...
public class RadioPlayer implements PlayerWrapper.PlayListener, Recordable {
    ...
    public final void play(final String stationURL, final String streamName, final boolean isAlarm) {
        ...
        MainRadioHelper radioDroidApp = (MainRadioHelper) mainContext.getApplicationContext();
